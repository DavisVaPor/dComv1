    ...
    <div class="flex h-screen bg-gray-800 " :class="{ 'overflow-hidden': isSideMenuOpen }">
                ...
                <div class="text-white">
                    ...
                    <div>
                        <ul class="leading-10 ml-2">
                            ...
                            @if (Auth::user()->rol_id == '2')
                                <li class="relative px-1 ">
                                    <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500"
                                        ...
                                        <svg aria-hidden="true" class="h-6 w-6" focusable="false" data-prefix="fas"
                                            data-icon="tasks" class="svg-inline--fa fa-tasks fa-w-16" role="img"
                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <path fill="currentColor"
                            ...
                            <p class="ml-2 border-green-500 border-b-2 mb-1 text-sm text-gray-50 opacity-80">Actividades
                                Realizadas
                            </p>
                            <li class="relative px-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500"
                            ...
                            {{-- <li class="relative px-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-green-500"
                                    ...
                                    <span class="ml-2 text-xs">SINIESTRO</span>
                                </a>
                            </li> --}}
        ...
        <div class="flex flex-col flex-1 w-full overflow-y-auto">
            ...
            <main class="">
                ...
                <div class="grid mb-2 text-sm pb-6 px-8 mx-4 max-h-full rounded-3xl bg-gray-100 border-4 border-green-400">
