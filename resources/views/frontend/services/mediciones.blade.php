...
@section('content')
    ...
    <div class="relative z-10 bg-cover" style="background-image: url(images/Capa.jfif)">
        <div class="container">
            ...
            <div class="flex">
                <div class="w-full mx-4">
                    <div class="pb-10 section-title">
                        <h4 class="title text-blue-600 text-center">Mediciones de Radiacion no Ionizante</h4>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="flex">
