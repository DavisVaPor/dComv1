<div class="container">
    ...
    <table class="table-auto rounded-t-lg m-5 w-11/12 mx-auto bg-gray-500 text-gray-800">
        ...
        @empty(!$commissions)
            ...
            <tr class="bg-gray-100 border-b border-gray-400 py-1 hover:bg-green-100">
                ...
                <td class="w-1/2 text-sm px-2 text-left uppercase">
                    <a href="{{ route('commision.show', [$commission]) }}"
                    ...
                    <div class="flex justify-center">
                        ...
                        @if ($commission->estado == 'CONFIRMADA')
                            <a href="{{ route('commisionpdf', [$commission]) }}"
                                ...
                                <svg class="w-8 h-8 m-auto" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 576 512">
