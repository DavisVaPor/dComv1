<div>
    <div class="flex my-3">
        ...
        <select class="rounded-lg mr-6" wire:model='provinciaSearch' name="" id="">
        ...
        <select class="rounded-lg mr-6" wire:model='estado' name="" id="">
            <option selected value="">Estados</option>
            <option class="text-green-500 font-bold" value="1">Operativo</option>
            <option class="text-red-500 font-bold" value="0">Inoperativo</option>
        </select>
    ...
    <div class="mx-auto rounded-md bg-gray-100 py-8 justify-center md:grid-cols-3 grid grid-cols-1 gap-2 ">
        @foreach ($estations as $estation)
                <div class="bg-white w-90 shadow-2xl rounded-xl">
                    <div class="p-2">
                        <a href="{{ route('estacion.show', [$estation]) }}" class="text-blue-700 flex items-center justify-center">
                            <i>
                                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="broadcast-tower" 
                                class="svg-inline--fa fa-broadcast-tower fa-w-20 w-8 h-8 mr-2" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                            ...
                            <h2 class="text-lg font-bold text-blue-700 text-center uppercase underline">{{ $estation->name }}</h2>
                        </a>
                        <div class="flex">
                            <h3 class=" ml-3 my-2 text-base font-semibold">Latitud :</h3>
                            <p class="font-light  text-gray-500 text-base ml-3 my-2">{{ $estation->latitud }} S</p>
                        </div>
                        <div class="flex">
                            <h3 class=" ml-3 my-2 text-base font-semibold">Longitud :</h3>
                            <p class="font-light text-gray-500 text-base ml-3 my-2">{{ $estation->longitud }} W</p>
                        </div>
                        {{-- <div class="flex">
                            <h3 class=" ml-3 my-2 text-base font-semibold">Altitud :</h3>
                            @empty(!$estation->altitud )
                                <p class="font-light text-gray-700 text-base ml-3 my-2">{{ $estation->altitud }} m.s.n.m</p>
                            @else
                                <p class="font-light text-gray-700 text-base ml-3 my-2">Sin registro</p>   
                            @endempty
                        </div> --}}
                        <div class="flex">
                            <h3 class=" ml-3 my-2 text-base font-semibold">Tipo :</h3>
                            <p class="font-normal text-blue-700 text-base ml-3 my-2">{{ $estation->tipo }}</p>
                        </div>
                        <div class=" ">
