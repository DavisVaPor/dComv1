<div>
                    ...
                    <div class="grid grid-cols-1 gap-2">
                        <div class=" col-span-2">
                            <div class="flex mb-2 border-b border-gray-600">
                                ...
                                <div class="w-9/12">
                                    <span
                                        class=" text-gray-900 block font-bold uppercase">{{ $item->denominacion }}</span>
                                </div>
                            </div>
                            ...
                            @if ($item->cantidad > 1)
                                <div class="flex mb-2 border-b border-gray-600">
                                    ...
                                    <div class="w-9/12">
                                        <span
                                            class=" text-gray-900 block font-bold uppercase">{{ $item->cantidad }}</span>
                                    </div>
                                </div>
                            @endif
                            <div class="flex mb-2 border-b border-gray-600">
                                ...
                                <div class="w-9/12">
                                    <span class=" text-gray-900 block font-bold uppercase">{{ $item->modelo }}</span>
                                </div>
                            </div>
                            <div class="flex mb-2 border-b border-gray-600">
                                <div class="w-3/12">
                            ...
                            <div class="flex mb-2 border-b border-gray-600 items-center">
                                ...
                                <div class="w-9/12">
                                    <span
                                        class=" text-gray-900 block font-bold uppercase">{{ $item->category->name }}</span>
                                </div>
                            </div>
                            <div class="flex mb-2 border-b border-gray-600">
                                <div class="w-3/12">
                                ...
                                <div class="w-9/12">
                                    @if ($item->color)
                                        <span class=" text-gray-900 block font-bold">{{ $item->color }}</span>
                                    @else
                            ...
                            <div class="flex mb-2 border-b border-gray-600">
                                ...
                                <div class="w-9/12">
                                    <span class=" text-gray-900 block font-extrabold">{{ $item->created_at }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="w-full font-extrabold text-gray-600">
        <div class="tab-content mb-2">
            <div class="pl-6 pr-6 pb-2 text-gray-500">
                <div class="bg-white rounded-lg w-full mb-2 p-4 shadow">
                    <h2 class="mb-4 text-lg text-blue-500 uppercase"> Ubicacion del Equipo</h2>
                    <div class="text-sm">
                        <div class="flex mb-2 border-b border-gray-600">
                            <div class="w-3/12">
                                <span class=" text-gray-900 block uppercase">Almacen</span>
                            </div>
                            <div class="w-1/12">
                                <span class=" text-gray-900 block">:</span>
                            </div>
