    ...
    <div class=" text-gray-500">
        ...
        <table class="text-sm text-center rounded-t-lg m-5 w-full mx-auto bg-gray-200 text-gray-800">
            <tr class="text-base border-b-2 border-gray-300">
                ...
                <th class="px-2 py-3">Descripcion del Servicio de Reparación</th>
            ...
            @empty
                <tr class="bg-gray-100 border-b border-gray-200">
                    <td colspan="5" class="px-4 mb-auto font-bold text-center mt-2"> 
                        No registro de reparaciones
                    </td>
                </tr>
            @endforelse
        </table>
