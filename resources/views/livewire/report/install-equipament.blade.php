                ...
                <tr class="bg-gray-100 border-b border-gray-200">
                    ...
                    <td class="text-center">
                        <abbr title="Ver Constancia">
                            <button wire:click="openModal({{$installation}})" class="text-gray-500 hover:text-gray-900 cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" viewBox="0 0 20 20" fill="currentColor">
...
@if ($installog)
     ...
     <x-jet-dialog-modal wire:model="modal">
        ...
        <x-slot name="content">
            <h1>Equipo: {{$installog->article->denominacion}}</h1>
            <h2>Serie: {{$installog->article->nserie}}</h2>
            <h2>Modelo: {{$installog->article->modelo}}</h2>
            <iframe src="//www.nothuman.net/images/files/discussion/1/e72f9f1f181a66887baa7270037c582e.pdf" width="100%" height="400px">
            </iframe>
        </x-slot>
